...
if hello[exploit()] == false then
    game:GetService("Players").LocalPlayer:Kick("Not Support " .. exploit())
else
...
local Window = Fluent:CreateWindow({
    Title = "Synet Hub",
    SubTitle = "Blox KumaNiga",
    TabWidth = 150,
    Size = UDim2.fromOffset(590, 240),
        ...
        pcall(function()
            while wait() do
                if _G.AutoQuestRace then
                    ...
                    elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "Fishman" and game:GetService("Workspace").Map:FindFirstChild("FishmanTrial") then
                        for i,v in pairs(game:GetService("Workspace").SeaBeasts.SeaBeast1:GetDescendants()) do
                            if v.FindFirstChild("HumanoidRootPart") and _G.AutoQuestRace and (v:FindFirstChild("HmanoidRootPart").Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 800 then
                                Tween(v.FindFirstChild("HumanoidRootPart").CFrame * CFrame.new(0,450,0))
                                for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
                                    if v:IsA("Tool") then
